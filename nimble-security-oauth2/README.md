...
This will deploy `target/nimble-security-oauth2.ear`.
 
The application will be running at the following URL <http://localhost:8080/nimble-security-oauth2/>.
